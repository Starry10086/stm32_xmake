...
#define BL_PARAM_MAIN_ADDR      (BL_PARAM_START_ADDR + 0x000U)
#define BL_PARAM_BACKUP_ADDR    (BL_PARAM_START_ADDR + 0x100U)
#define BL_LOG_ADDR             (BL_PARAM_START_ADDR + 0x200U)

#define BL_LOG_ENTRY_SIZE       32U
#define BL_LOG_ENTRY_COUNT      32U
